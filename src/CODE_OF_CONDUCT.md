...
Dada a natureza do projeto GEMLAB (blockchain, certificação gemológica, compliance fiscal), esperamos que os colaboradores:

* 🔬 **Rigor Científico:** Mantenham precisão técnica em discussões sobre gemologia, espectroscopia e protocolos de certificação
* ⚖️ **Responsabilidade Regulatória:** Respeitem as implicações legais do projeto e evitem promover uso não-compliance das ferramentas
* 🌱 **Compromisso ESG:** Alinhem contribuições com os objetivos de sustentabilidade e impacto social do projeto
* 🔐 **Segurança First:** Reportem vulnerabilidades de forma responsável através do processo descrito em SECURITY.md
...
Instâncias de comportamento abusivo, de assédio ou de outra forma inaceitável podem ser reportadas entrando em contato com a equipe do projeto em **conduct@gemlab.tech**. Todas as reclamações serão revisadas e investigadas e resultarão em uma resposta considerada necessária e apropriada às circunstâncias. A equipe do projeto é obrigada a manter confidencialidade em relação ao relator de um incidente.
...
1. **Relato:** Envie um e-mail para conduct@gemlab.tech com detalhes do incidente
2. **Confirmação:** Você receberá confirmação de recebimento em até 48 horas
3. **Investigação:** A equipe revisará o caso de forma confidencial
4. **Resolução:** Ação apropriada será tomada (aviso, suspensão temporária, ban permanente)
5. **Apelação:** Decisões podem ser apeladas enviando justificativa para o mesmo e-mail
...
Agradecemos a todos os colaboradores que ajudam a manter a comunidade GEMLAB um espaço seguro, respeitoso e produtivo para inovação em blockchain e sustentabilidade mineral.

---

**Versão:** 1.0  
**Última atualização:** Dezembro 2024  
**Contato:** conduct@gemlab.tech
